...
rbar_o = 1e2;
rho_0_o = 10;
tau = -1/rbar_o*log(1/((rho_0_o-rho_inf_o)*rbar_o));
rho_o = create_rho(rho_0_o, tau, rho_inf_o);
...
tmax = 50;
ode_options = odeset('AbsTol', 1e-10, 'RelTol', 1e-9, ...
...
plotter('t', t(1:5:end), 's', e(1:5:end, 1), 'rho', rho_o);
plotter('t', t(1:5:end), 's', e(1:5:end, 2), 'rho', @(t) rho_o(t - peak));
